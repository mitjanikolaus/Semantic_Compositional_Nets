...
def check_args(args):
    ...
    parser.add_argument(
        "--decode-results", help="Path decoding results", required=True
    )
...
if __name__ == '__main__':
    ...
    # generated captions
    generated_captions = pickle.load(open(parsed_args.decode_results, "rb"))
    ...
    coco_ids = [str(key) for key in generated_captions.keys()]
